...
namespace HMS_Client
{
    ...
    public partial class HelideckMotionHistory_NOROG : UserControl
    {
        ...
        public void Init(HelideckMotionTrendVM helideckMotionTrendVM)
        {
            ...
            chartPitch20m.Series[0].ItemsSource = helideckMotionTrendVM.pitch20mList;
            chartRoll20m.Series[0].ItemsSource = helideckMotionTrendVM.roll20mList;
            ...
            chartPitch3h.Series[0].ItemsSource = helideckMotionTrendVM.pitch3hList;
