...
namespace HMS_Client
{
    ...
    public class Config
    {
        ...
        public Config()
        {
            ...
            appConfigMap.ExeConfigFilename = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Swire Energy Services\\HMS Client\\HMS_Client.config");
            ...
            configMap.ExeConfigFilename = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Swire Energy Services\\HMS Client\\ClientData.config");
