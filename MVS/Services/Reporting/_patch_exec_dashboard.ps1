...
$start = $content.IndexOf('		public static byte[] RenderExecutiveDashboard')
...
$newMethod = [System.IO.File]::ReadAllText("MVS\Services\Reporting\_exec_dashboard_new.cs", [System.Text.Encoding]::UTF8)

$before = $content.Substring(0, $start)
$after  = $content.Substring($end + 1)
$newContent = $before + $newMethod + $after
[System.IO.File]::WriteAllText($file, $newContent, [System.Text.Encoding]::UTF8)
Write-Host "Patched. New size: $($newContent.Length)"
